...
# Version 1.0 - Extension Attribute number of accounts Version
...
# add accounts separated by a space in the array below
...
#cho "Found the following accounts with 'dsAttrTypeNative:_writers_passwd':"
...
echo "<result>$numberOfAccounts</result>"